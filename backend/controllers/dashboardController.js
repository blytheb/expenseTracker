...
export const getDashboardData = async (req, res) => {
    try {
        ...
        //get total income for last 60 dats
        ...
        console.log("Last30day expense ", last30DaysExpenseTransactions);
        ...
        res.status(500).json({message: "server error in dashboardcontroller", error});
    }
